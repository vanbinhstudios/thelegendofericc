    ...
    public static Action returnAction(PositionComponent pos, int x, int y, Map map, int moveDelay, StatsComponent stats) {
        ...
        if (obstacle != null && Mappers.player.has(obstacle)) {
            if (stats.canUseSkills && stats.mana > 50) {
                ...
                switch (rand) {
                    case 1:
                        return Actions.AOE_ATTACK(Models.explosion3, pos.map.calculateRay(pos.xy, pos.dir, 8), pos.dir, 300, stats.strength, 50); // TODO change models
                    default:
                    case 0:
                        return Actions.AOE_ATTACK(Models.explosion1, pos.map.calculateFOV(pos.xy, 2), pos.dir, 200, stats.strength, 50); // TODO here too
                }
            } else {
                return Actions.AOE_ATTACK(Models.sword, pos.map.calculateFOV(targetPos, 0), dir, 100, stats.strength, 50);
            }
        }
